...
export default function Catalog() {
  ...
  return (
    ...
    <div className="flex gap-2 grow-0 mx-2 w-2/3 self-center">
      <div className=" h-max bg-gray-300 rounded-lg basis-1/5">
      ...
      <div className=" bg-slate-300 rounded-lg overflow-auto flex gap-12 p-12 flex-wrap place-items-center basis-4/5">
